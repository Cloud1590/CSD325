...
class Todo(tk.Tk):
    def __init__(self, tasks=None):
        ...
        # Requirement 1: Change title
        self.title("Vance-ToDo")
        self.geometry("300x400")

        # Requirement 2 & 5: Add colored File -> Exit menu
        menubar = tk.Menu(self, bg="navy", fg="lightyellow")
        ...
        # Requirement 4: Add instruction label
        self.instructions = tk.Label(
            self.text_frame,
            text="To delete a task, RIGHT-click on it.",
            bg="lightblue"
        )
        ...
        # Requirement 3: Change to RIGHT mouse click
